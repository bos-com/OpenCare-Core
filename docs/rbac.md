...
This guide describes how role-based access control (RBAC) is implemented in OpenCare-Core and how to work with the new role metadata introduced for [issue #6](https://github.com/bos-com/OpenCare-Core/issues/6).
